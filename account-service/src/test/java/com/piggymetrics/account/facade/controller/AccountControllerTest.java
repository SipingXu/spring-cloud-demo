...
public class AccountControllerTest {
    ...
    public void shouldGetAccountByName() throws Exception {
        ...
        when(accountService.findByName(accountDTO.getName())).thenReturn(accountDTO);

        mockMvc.perform(get("/" + accountDTO.getName()))
    ...
    public void shouldGetCurrentAccount() throws Exception {
        ...
        mockMvc.perform(get("/current").principal(new UserPrincipal(accountDTO.getName())))
                .andExpect(jsonPath("$.name").value(accountDTO.getName()))
                .andExpect(status().isOk());
    }
